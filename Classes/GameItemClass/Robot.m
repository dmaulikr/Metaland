...
+ (void)initializeSpriteFrames : (int)type {
    switch (type)
    {
        ...
        {
            [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"player_5.plist"];
            initialSpriteFrame = [[CCSpriteFrameCache sharedSpriteFrameCache]spriteFrameByName:@"player_5-1.png"];
            ...
            if (sprite) {
                ...
                for(int i = 1; i <= 7; ++i) {
                    [animationFramesRun addObject:
                     [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName: [NSString stringWithFormat:@"player_5-%d.png", i]]];
                }
